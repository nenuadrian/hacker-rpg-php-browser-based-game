...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_f885d5b526260c833c31139b1ffe01b8' . $path_separator);
  ...
  $dbPort = '3307';    # dev database name/prefix
  $dbn    = 'bot';    # dev database name/prefix
  ...
  $remember_up_to = 10;
  $debugemail = 'adrian.nenu@gmail.com';
