...
<div class="row">
	...
	<div class="col-md-4 text-center">
		...
		<form method="post" style="margin-top:50px">
			<input type="text" class="form-control text-center" placeholder="user id" name="username" required value="<?php echo Input::post('username', ''); ?>" />
			<input type="email" class="form-control text-center" placeholder="email address" name="email" required value="<?php echo Input::post('email', ''); ?>" />
